...
- **외부 활동:** 다양한 분야를 경험하기 위한 여러 분야의 스터디 진행
  - **진행 방식:** 디스코드 같은 플랫폼을 이용하여 온라인, 오프라인 스터디를 진행함.

#### 2️⃣ 팀 활동 방향
- **활동 선정 기준:** 팀 발표 활동 시 조사한 관심사를 기반으로 설정
  - **분야:** 정보보호, 게임 프로그래밍, 인공지능 등
  - **도구:** 팀원 각각의 관심사 수집 후 WordCloud 형태로 변환
![TeamGwansimsa](img/Team.png)

#### 3️⃣ 성과
- **티켓 획득:** 모든 빙고판 활동 완료, 티켓 과제 33개 + 팀 활동 보고발표 10개 => 총 43개 티켓 획득으로 빙고판 완성
![Bingo](img/Bingo.png)

#### 4️⃣ 후기 및 다짐
<img src = "img/graph.jpg" width="100%"/>
